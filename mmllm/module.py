...
class InstructCell(PreTrainedModel):
    ...
    def from_pretrained(
        ...
        **kwargs
        ...
        load_tokenizer_kwargs: Dict[str, Any], default {}
            Additional keyword arguments passed to the ``from_pretrained`` method of the class
            ``transformers.PreTrainedTokenizer`` or ``transformers.PreTrainedTokenizerFast``.
        **kwargs
